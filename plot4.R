## plot4.R
## This script produces a PNG quad plot of electric power consumption data.
## 
...
plot(powData$V1, powData$V5, type="l", xlab="datetime", 
     ylab="Voltage")
...
plot(powData$V1, powData$V4, type="l", xlab="datatime", 
